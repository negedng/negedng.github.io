...
Gergely Dániel Németh is Hungarian Machine Learning Engineer. He holds a PhD in Artificial Intelligence from the ELLIS Unit Alicante. His PhD topic was Federated Learning. His supervisors are Nuria Oliver (ELLIS Alicante), Miguel Angel Lozano (University of Alicante) and Novi Quadrianto (University of Sussex).
...
## PhD project
My PhD topic was Federated Learning (FL), a privacy-preserving method for collaborative machine learning where the private data never leaves the client's machine while partners share their machine learning model weights to improve the global understanding of the problem with a aggregated model. My work focused on the model, participation and data heterogeneity in FL as well as privacy and fairness in FL. During the 4 year PhD, I observered and understood the limitations of Federated Learning, I gained more understanding in how machine learning models preserve the training data and I suggested directions to improve the privacy of ML in critical environments. The main takeaway of my studies is that the more unique someone's data is in the training set, the more vulnerable they are against privacy attacks and any optimization to harness the under-represented data to have a well-generalized model comes with privacy trade-offs.
## University projects
